...
final class GMLuaDefineBaseClassTests: XCTestCase {
    func testParenthesizedAndBareStringDirectivesCreateDistinctLexicalBindings() throws {
        ...
        try state.execute(
            ...
            assert(rawget(_G, "BaseClass") == nil)
            """#,
            sourceName: "@GLuaDefineBaseClassRegression.lua"
        )
    }
}
